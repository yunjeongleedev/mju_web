...
module.exports = (app, io) => {
  ...
  const connStr = 'mongodb+srv://YunJeong:arsenal1st!@yunjeongcluster0-cyuda.mongodb.net/gongmo?retryWrites=true';
  ...
  app.use('/', index);
  app.use('/users', users);
  app.use('/gongmos', gongmos(io)); // socket.io를 인자로 주기 위해 function으로 변경
